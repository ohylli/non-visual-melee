...
if (_aurora_nod_provider STREQUAL "auto")
  ...
  if (CMAKE_SYSTEM_NAME STREQUAL "Windows" AND _target_arch MATCHES "^(AMD64|x86_64)$")
    set(_has_package TRUE)
  elseif (CMAKE_SYSTEM_NAME STREQUAL "Windows" AND _target_arch MATCHES "^(ARM64|arm64|aarch64)$")
    set(_has_package TRUE)
  elseif (CMAKE_SYSTEM_NAME STREQUAL "Linux" AND _target_arch MATCHES "^(x86_64|aarch64)$")
    set(_has_package TRUE)
...
elseif (_aurora_nod_provider STREQUAL "package")
  ...
  if (NOT AURORA_NOD_PACKAGE_URL)
    ...
    if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
      if (_target_arch MATCHES "^(AMD64|x86_64)$")
        set(_nod_platform "windows-x86_64")
      elseif (_target_arch MATCHES "^(ARM64|arm64|aarch64)$")
